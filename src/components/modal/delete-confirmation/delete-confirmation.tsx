...
import { StyledDeleteConfirmationButtonsContainer, StyledDeleteConfirmationContainer } from "./styles"
...
const DeleteConfirmation = (props: DeleteConfirmation) => {
  ...
  return (
    <StyledDeleteConfirmationContainer>
      ...
      <SpanText variant='NUNITO_14_400_20' color="#5C6269">Are you sure you want to delete this item? This can not be undone.</SpanText>
